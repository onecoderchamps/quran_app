...
const surahData = {
  1: surah1, 2: surah2, 3: surah3, 4: surah4, 5: surah5,
  6: surah6, 7: surah7, 8: surah8, 9: surah9, 10: surah10,
  11: surah11, 12: surah12, 13: surah13, 14: surah14, 15: surah15,
  16: surah16, 17: surah17, 18: surah18, 19: surah19, 20: surah20,
  21: surah21, 22: surah22, 23: surah23, 24: surah24, 25: surah25,
  26: surah26, 27: surah27, 28: surah28, 29: surah29, 30: surah30,
  31: surah31, 32: surah32, 33: surah33, 34: surah34, 35: surah35,
  36: surah36, 37: surah37, 38: surah38, 39: surah39, 40: surah40,
  41: surah41, 42: surah42, 43: surah43, 44: surah44, 45: surah45,
  46: surah46, 47: surah47, 48: surah48, 49: surah49, 50: surah50,
  51: surah51, 52: surah52, 53: surah53, 54: surah54, 55: surah55,
  56: surah56, 57: surah57, 58: surah58, 59: surah59, 60: surah60,
  61: surah61, 62: surah62, 63: surah63, 64: surah64, 65: surah65,
  66: surah66, 67: surah67, 68: surah68, 69: surah69, 70: surah70,
  71: surah71, 72: surah72, 73: surah73, 74: surah74, 75: surah75,
  76: surah76, 77: surah77, 78: surah78, 79: surah79, 80: surah80,
  81: surah81, 82: surah82, 83: surah83, 84: surah84, 85: surah85,
  86: surah86, 87: surah87, 88: surah88, 89: surah89, 90: surah90,
  91: surah91, 92: surah92, 93: surah93, 94: surah94, 95: surah95,
  96: surah96, 97: surah97, 98: surah98, 99: surah99, 100: surah100,
  101: surah101, 102: surah102, 103: surah103, 104: surah104, 105: surah105,
  106: surah106, 107: surah107, 108: surah108, 109: surah109, 110: surah110,
  111: surah111, 112: surah112, 113: surah113, 114: surah114,
};

const MushafModeScreen = ({ route, navigation }) => {
  const initialPage = parseInt(route.params.surahNumber) - 1;
  const pagerViewRef = useRef(null);

  useEffect(() => {
    // Navigasi ke surah awal saat komponen dimuat
    if (pagerViewRef.current) {
      pagerViewRef.current.setPageWithoutAnimation(initialPage);
    }
  }, [initialPage]);

  const renderSurahPage = (surah) => {
    if (!surah) {
      return (
        <View style={styles.errorContainer}>
          <Text style={styles.errorText}>Data surah tidak ditemukan.</Text>
        </View>
      );
    }
    ...
    const renderHeader = () => {
      return (
        <View style={styles.pageHeader}>
          ...
          <Text style={styles.surahNameLatin}>{surah.name_latin} ({surah.number_of_ayah} Ayat)</Text>
    ...
    const renderContinuousText = () => {
      return ayahNumbers.map((ayahNumber) => (
        <React.Fragment key={ayahNumber}>
          <Text>
            <Text style={styles.ayahText}>
              {arabicText[ayahNumber]}
              {' '}
            </Text>
            <Text style={styles.ayahNumberCircle}>
              {`${ayahNumber}`}
            </Text>
            {' '}
          </Text>
  ...
  const allSurahNumbers = Object.keys(surahData);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        {allSurahNumbers.map((surahNum) => (
          <View key={surahNum} style={styles.page}>
            {renderSurahPage(surahData[surahNum][surahNum])}
          </View>
        ))}
      </PagerView>
    </SafeAreaView>
...
export default MushafModeScreen;